            ...
            <div className="app__chef-content">
                <div className="app__chef-content_quote">
                    ...
                    <p className="p__opensans">
                        ...
                        Obcaecati, excepturi officia quibusdam earum asperiores
                        eaque libero eius atque sit magnam! Tenetur similique
                        rem accusamus at dolorum officia ducimus eaque neque!
                    </p>
                </div>
                <p className="p__opensans">
